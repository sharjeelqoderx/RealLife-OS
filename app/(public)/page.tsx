...
function NavLogo() {
  return (
    <Image
      ...
      height={296}
      priority
      className="h-auto max-h-10 w-auto max-w-[200px] object-contain object-left sm:max-w-[220px]"
    />
  );
}
...
function FooterLogo() {
  return (
    <Image
      ...
      width={1224}
      height={296}
      className="h-auto max-h-10 w-auto max-w-[200px] object-contain object-left"
    />
  );
}
...
function SectionGlow({
  ...
  const horizontal =
    side === "left"
      ? "left-0 -translate-x-1/3 sm:left-10 sm:translate-x-0"
      : side === "right"
        ? "right-0 translate-x-1/3 sm:right-10 sm:translate-x-0"
        : "left-1/2 -translate-x-1/2";

  const vertical =
    align === "top"
      ? "top-0 -translate-y-1/3 sm:top-10 sm:translate-y-0"
      : side === "center"
        ? "bottom-16 sm:bottom-24"
        : "bottom-0 translate-y-1/3 sm:bottom-10 sm:translate-y-0";

  return (
    <div
      aria-hidden
      className={`pointer-events-none absolute size-220 rounded-full blur-3xl ${glowClass} ${horizontal} ${vertical}`}
    />
  );
}
    ...
    <div className="relative min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <header className="sticky top-0 z-50 bg-slate-50/80 backdrop-blur-md">
        <div className={`${pageContainerClass} flex items-center justify-between py-4`}>
          <Link href="/" className="shrink-0" aria-label="RealLife OS home">
            <NavLogo />
          </Link>
          ...
          <Link
            href="/sign-up"
            className="rounded-lg bg-brand-primary px-5 py-2.5 text-sm font-semibold text-brand-primary-foreground transition-all hover:bg-brand-primary/90"
          >
            Start Free
          </Link>
        </div>
      ...
      <section className="relative px-4 pb-20 pt-16 sm:px-6 lg:px-8">
        ...
        <div className={`${pageMaxWidthClass} relative z-10 text-center`}>
          <div className="mb-6 inline-flex items-center gap-1.5 rounded-full border border-cyan-200 bg-cyan-50 px-4 py-1.5 text-sm font-medium text-cyan-700">
            <ShieldCheck className="size-3.5" />
            DNS Security + Willpower Tracking
          </div>
      ...
      <section
        id="features"
        className="relative bg-slate-50 px-4 py-20 sm:px-6 lg:px-8"
      >
        ...
        <div className={`relative z-10 ${pageMaxWidthClass}`}>
          ...
          <div className="mx-auto mt-12 grid max-w-5xl grid-cols-1 gap-6 lg:grid-cols-3 lg:items-stretch">
            {[
              ...
              <div
                key={plan.tier}
                className={`relative flex h-full flex-col rounded-2xl border bg-white p-8 ${plan.highlighted
      ...
      <section className="relative z-10 bg-[#020617] px-4 py-20 sm:px-6 lg:px-8">
        <div className={`${pageMaxWidthClass} relative z-10`}>
          ...
          <div className="mx-auto mt-12 flex w-full flex-wrap items-center justify-center gap-x-10 gap-y-4 rounded-xl bg-slate-900/40 px-6 py-5 sm:gap-x-14 sm:px-10">
      ...
      <section className="relative z-10 bg-slate-50 px-4 py-20 sm:px-6 lg:px-8">
        <div className={pageMaxWidthClass}>
          <div className="relative overflow-hidden rounded-[2rem] px-6 py-16 text-center sm:px-12 sm:py-20">
            ...
            <div className="pointer-events-none absolute -left-20 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-brand-primary/45 blur-3xl" />
            <div className="pointer-events-none absolute -right-16 top-0 h-56 w-56 rounded-full bg-white/35 blur-3xl" />
